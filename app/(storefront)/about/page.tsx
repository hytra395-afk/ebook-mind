      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          <div className="bg-purple-50 rounded-xl p-6">
            <h3 className="font-bold bg-gradient-to-r from-indigo-500 via-violet-500 to-fuchsia-500 bg-clip-text text-transparent mb-2">Chất lượng</h3>
            <p className="text-sm text-gray-600">Mỗi ebook được biên soạn kỹ lưỡng bởi các chuyên gia</p>
          </div>
          <div className="bg-purple-50 rounded-xl p-6">
            <h3 className="font-bold bg-gradient-to-r from-indigo-500 via-violet-500 to-fuchsia-500 bg-clip-text text-transparent mb-2">Giá cả hợp lý</h3>
            <p className="text-sm text-gray-600">Kiến thức giá bằng một cốc trà sữa</p>
          </div>
          <div className="bg-purple-50 rounded-xl p-6">
            <h3 className="font-bold bg-gradient-to-r from-indigo-500 via-violet-500 to-fuchsia-500 bg-clip-text text-transparent mb-2">Tiện lợi</h3>
