...
import { ArrowLeft, Trash2, Save, Send, Eye, Package, Image as ImageIcon, FileText, Star, Search, X } from 'lucide-react'
    ...
    const load = async () => {
      ...
      if (comboRes.data) {
        ...
        setForm({
          ...
          og_image_url: combo.og_image_url || '',
      ...
      setSelectedEbooks(comboItemsRes.data?.map((item: any) => item.ebook_id) || [])
